...
# list_unharness = table_Testcases.selectFuzzingTimeDistributedFromTableTestcase(0,60000,60000)
...
# list_unharness = table_Testcases.selectIdFromTableTestcase(255)
...
def muti_harness(testcase):
    ...
    if save2TestcaseTable:
        ...
        if AllCov is not None and len(AllCov) != 0:
...
id_list = table_Testcases.selectEngine_coverage_integration_all_is_null_and_MutationTimeIsNOT0RangeFromTableTestcase(499,3500)
