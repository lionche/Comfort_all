...
import re
import os
from utils import createFolder, readFileAll
...
def replaceBlock(gpt_file_path,JSReplaceRoot,Root):
    orginal_path, gpt_path, js_number = getFilePath(gpt_file_path,Root)
...
def replacedBlockFolder(Root):
    ...
    JSReplaceRoot = Root + '/replaced_block'
    ...
    for root, dirs, files in os.walk(JSGptRoot):
        for file in files:
            ...
            replaceBlock(gpt_file_path,JSReplaceRoot,Root)
